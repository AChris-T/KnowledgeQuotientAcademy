...
export default function TeachersSection() {
  return (
    <motion.section
      className="flex flex-col lg:flex-row font-outfit md:items-start items-center justify-center  py-16"
    ...
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <div className="grid gap-8 md:gap-3  md:grid-cols-3 w-full mx-auto">
          {teachers.map((t, i) => (
            <motion.div
              key={i}
